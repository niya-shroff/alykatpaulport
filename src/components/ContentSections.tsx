...
import { Music, Youtube, Camera, BookOpen, ExternalLink, Play, Eye, Heart, Clock, Radio } from 'lucide-react';
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="lg:order-2">
              <div className="flex items-center mb-6">
                ...
                <h2 className="text-4xl font-bold text-gray-800">Travel Blog</h2>
              </div>
              <p className="text-xl text-gray-600 mb-8 leading-relaxed">
                Follow my travel adventures and photography journey. From hidden gems to 
                popular destinations, I share honest insights, stunning visuals, and 
                practical tips for fellow wanderers.
              </p>
              <a
            ...
            <div className="lg:order-1 relative">
              <div className="bg-gradient-to-br from-blue-500 to-blue-600 rounded-3xl p-8 text-white shadow-2xl transform -rotate-3 hover:rotate-0 transition-transform duration-300 border border-blue-400">
                <div className="text-center">
                  <BookOpen className="w-16 h-16 mx-auto mb-4 opacity-80" />
                  <h3 className="text-2xl font-bold mb-2">Travel Stories</h3>
                  <p className="opacity-90">Adventures captured through words and photos</p>
                </div>
              </div>
            </div>
          </div>
